...
texts = {
    None : pyglet.text.Label("E : enemy, C : clothing, F : player, W : Wall, D : Demolish, B : Blocker", font_name = 'Times New Roman', 
    ...
    "BLOCKER" : pyglet.text.Label("Creating blocker", font_name = 'Times New Roman', font_size = 20, anchor_x = 'center', anchor_y = 'center', x = width // 2, y = height - 100),
    "CLOTH" : pyglet.text.Label("Creating clothing", font_name = 'Times New Roman', font_size = 20, anchor_x = 'center', anchor_y = 'center', x = width // 2, y = height - 100),
